<?php
        ...
        //      select `order_id` from `order` where `order_user_id` = '   openid  ' and `is_checked` = 0 order by `order_session_id` limit 1;
        $sql = "select `order_id` from `order` where `order_user_id` = '".$openid."' and `is_checked` = 0 order by `order_session_id` limit 1";
